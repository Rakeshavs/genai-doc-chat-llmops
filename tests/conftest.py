...
# Ensure `utils.*` imports resolve when tests run from the repo root.
MULTI_DOC_CHAT_ROOT = ROOT / "multi_doc_chat"
if str(MULTI_DOC_CHAT_ROOT) not in sys.path:
    sys.path.insert(0, str(MULTI_DOC_CHAT_ROOT))
